...
class Binance {
	...
	public function candlesticks($symbol, $interval = "1w") {
		return $this->request("v3/klines",["symbol"=>$symbol, "interval"=>$interval]);
	}
	public function candlesticksMonth($symbol, $interval = "1M") {
		return $this->request("v3/klines",["symbol"=>$symbol, "interval"=>$interval]);
	}
